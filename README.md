...
This project based on RTU Modbus Monitoring, the project I'm most proud of so far.
...
## Installation
 First you need to set your .env based on .env.example
...
- ./src/resources for API Development
- ./src/queue for execute redis-bull jobs 
